[12:46 pm, 31 / 12 / 2024] Raghad: #include <iostream>
using namespace std;
...
public:
    ...
    void insertKey(int k) {
        if (heap_size == capacity) {
            cout << …
                [12:47 pm, 31 / 12 / 2024] Hania: # MinHeap Implementation(C++)
            ...
            -Insertion of a new key.
                ...
                - *DecreaseKey(int i, int new_val) * : Decreases the value of a key at index i to new_…
                [12:55 pm, 31 / 12 / 2024] Hania : #include <iostream>
#include <stdlib.h>
#include <vector>
#include <set>
